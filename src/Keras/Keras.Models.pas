    ...
    begin
        ...
        begin
            ...
            begin
                ...
                var x := tf.keras.Input(default(TFShape), -1, layer.Name + '_input', layer.DType, False, nil, False, nil, @shp );
...
begin
    ...
    var inputs := tf.keras.Input(default(TFShape), -1, sName, input_dtype, False, nil, False, nil, @input_shape );
